(function (global, factory) {
  ...
  (global = global || self, global['btblab-vue-list'] = factory());
  ...
  var script$1 = {
      ...
      this.$props.sublist.map((entry) => {
        if (entry.children) {
          if (this.$props.collapseEnable && entry.defaultCollapsed === true) {
            ...
            this.toggleCollapsed(entry, 'hide');
          } else {
            this.$refs[`${entry.id}_sublayer`].map((node) => {
    ...
    methods: {
      ...
      toggleCollapsed: function (entry, state) {
        ...
        switch (state) {
          ...
          case 'show':
            ...
            break
          default:
            this.toggleCollapsed(entry, (this.env.collapsedSet.has(entry.id)) ? 'show' : 'hide');
            break
        }
      },
                        ...
                        "div",
                        {
                          ...
                          on: {
                            click: function($event) {
                              return _vm.toggleCollapsed(entry)
                            }
                          }
                        },
                        [
