...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createElementBlock("ul", {
    ...
    style: vue.normalizeStyle({ ..._ctx.getStyle(['btb-vue-list-layer', `layer-${_ctx.props.iteration}`]) })
  }, [
                  ...
                  ..._ctx.getStyle([
                    ...
                    (_ctx.collapsedSet.has(entry.id) && 'collapseBtn-on') || '',
                      ...
                      vue.createElementVNode("div", {
                        ...
                        style: vue.normalizeStyle({ ..._ctx.getStyle(['collapseBtn_arrow']) })
                      }, null, 4 /* STYLE */)
                    ], 6 /* CLASS, STYLE */))
...
script$1.__file = "src/list/ListLayer.vue";
...
script.__file = "src/list/List.vue";
